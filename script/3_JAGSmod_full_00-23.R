...
BugsData$T <- dim(BugsData$y)[2]-1  # to get data until 2023
...
# run model in JAGS
out_full_23 <- jags(BugsData, inits, params, "earlymodel.txt", n.thin=nt,
                 n.chains=nc, n.burnin=nb, n.adapt=na, n.iter=ni, parallel=T)   # 

# keep only MCMC values
out_full_23 <- out_full_23$sims.list

# save output
save(out_full_23, file="output/fullmod_00-23.RData")
