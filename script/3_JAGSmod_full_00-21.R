...
BugsData$T <- dim(BugsData$y)[2]-3  # to get data until 2021
...
# run model in JAGS
out_full_21 <- jags(BugsData, inits, params, "earlymodel.txt", n.thin=nt,
                 n.chains=nc, n.burnin=nb, n.adapt=na, n.iter=ni, parallel=T)   # 

# keep only MCMC values
out_full_21 <- out_full_21$sims.list

# save output
save(out_full_21, file="output/fullmod_00-21.RData")
