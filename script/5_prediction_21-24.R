...
ggplot(dat2, aes(x = year))  + 
  ...
  geom_point(aes(y=pred, x=year), size=5)+
...
# change new values
dat4 <- cbind(dat3, pred_early=(c(rep(NA, times=22), mean(mu_early_22), mean(mu_early_23), mean(mu_early_24), mean(mu_early_25))))
